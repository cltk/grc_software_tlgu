 ...
 * 15-May-2020 dm -- accented character table extension to accommodate U0370 block characters
 */
 ...
 * entries for U370 oxia, dialytica, dialytica-oxia
 *
 * If zero is returned, combining diacritical marks should be generated from the accent flags.
 * 
 * 15-May-2020 dm -- extra codes (offsets 0x20, 0x21, 0x22) added to the tables 
 *                   for U0370 acute (oxia) and diaeresis (dialytika) representations
 */
unsigned int alpha[] = {
